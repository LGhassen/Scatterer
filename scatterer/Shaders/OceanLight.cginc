...
#define OCEAN_TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, worldPos).xyz; TRANSFER_SHADOW(a)
...
#define OCEAN_TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, worldPos); TRANSFER_SHADOW(a)
...
#define OCEAN_TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, worldPos).xy; TRANSFER_SHADOW(a)
