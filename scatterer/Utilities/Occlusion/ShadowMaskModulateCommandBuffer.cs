...
//			m_ShadowMaskModulateMaterial.SetTexture ("OcclusionTexture", Scatterer.Instance.bufferRenderingManager.occlusionTexture);

			//after light's screenspace shadow mask is computed, modulate it by occlusion texture
//			m_Buffer.Blit (Scatterer.Instance.bufferRenderingManager.occlusionTexture, BuiltinRenderTextureType.CurrentActive, m_ShadowMaskModulateMaterial);
